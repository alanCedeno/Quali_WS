...
public class MainActivity extends Activity implements TextWatcher {
	...
	private static ArrayList<String> ciudad = new ArrayList<String>();
	private static ArrayList<String> cp = new ArrayList<String>();
...
//		btnSumEqEsp=(Button)findViewById(R.id.btnSumEqEsp);
        ...
        estado.add("México");        
        ArrayAdapter<String> adEstado = new ArrayAdapter<String>(this,R.layout.texto_spin, estado);      
        ...
        spEstado.setOnItemSelectedListener(new OnItemSelectedListener() {         
            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, 
            	...
            	ArrayList<String> cdLocal= new ArrayList<String>();
            	ArrayList<String> cpLocal= new ArrayList<String>();
            	cdLocal.clear();
            	cpLocal.clear();
            	if(position==0){
            		
            		cdLocal.add("Miguel Hidalgo");
            		cpLocal.add("11000- Lomas de Chapultepec");

            		tvCP.setText("11000- Lomas de Chapultepec");

            	}else{
            		cdLocal.add("Nezahualcoyotl");
            		cpLocal.add("57500- Agua Azul");
                    tvCP.setText("57500- Agua Azul");
            	...
            	//m.setCiudad(cdLocal);
            	//m.setCp(cpLocal);
            	MainActivity.cp = cpLocal;
            	MainActivity.ciudad = cdLocal;
            	ponCd();
       ...
       // MainActivity.ciudad.add("porquerias");
...
//        	            	btnSumEqEsp.setVisibility(View.VISIBLE);
...
//        	            	btnSumEqEsp.setVisibility(View.INVISIBLE);
...
//        btnSumEqEsp.setOnClickListener(new View.OnClickListener() {
//  	      @Override
//  	      public void onClick(View v) {	
//  	    	calculaPrimaNeta();
//  	    	  if(etSumEqEsp.getText().toString().equals("5000")){
//  	    		  tvPrimEquipoEspecial.setText("245.00");
//  	        	calculaPrimaNeta();
//  	    	  }else{
//  	    		  Toast.makeText(getApplicationContext(), "Solo se permite 5000", Toast.LENGTH_SHORT).show();
//  	    	  }
//  	    	  
//  	      }
//  	    });
	...
	public void ponCP() {
		...
		ArrayAdapter<String> adCP = new ArrayAdapter<String>(this,R.layout.texto_spin, MainActivity.cp);      
        spCP.setAdapter(adCP);
	...
	public void ponCd() {
		ArrayAdapter<String> adCiudad = new ArrayAdapter<String>(this,R.layout.texto_spin, MainActivity.ciudad);      
